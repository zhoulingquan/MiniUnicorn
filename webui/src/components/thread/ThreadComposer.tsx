    ...
    >
      ...
      <div
        className={cn(
          ...
          "after:pointer-events-none after:absolute after:inset-[-1px] after:rounded-[inherit] after:border after:border-[#AF7AAE]/75 after:opacity-0 after:transition-opacity after:duration-200 focus-within:after:opacity-100 dark:after:border-[#AF7AAE]/55",
          isHero
          ...
          "focus-within:border-[#AF7AAE]/75 dark:focus-within:border-[#AF7AAE]/55",
          disabled && "opacity-60",
