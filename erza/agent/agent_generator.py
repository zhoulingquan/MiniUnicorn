...
:class:`erza.agent.subagent_registry.SubagentRegistry`.
...
_SYSTEM_PROMPT = """\
You are a subagent definition generator for the erza AI agent framework.
...
and parseable by erza's SubagentRegistry.
