"""JSON Schema fragment types: all subclass :class:`~erza.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~erza.tools.base.Schema.validate_json_schema_value` /
  :class:`~erza.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~erza.tools.base.Schema`.
...
from erza.tools.base import Schema
