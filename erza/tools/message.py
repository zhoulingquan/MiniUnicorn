...
from erza.config.paths import get_workspace_path
...
from erza.tools.path_utils import resolve_workspace_path
from erza.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from erza.utils.helpers import strip_think
