...
from erza.utils.helpers import build_status_content
from erza.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "erza"] + sys.argv[1:])
...
def register_builtin_commands(router: CommandRouter) -> None:
    ...
    from erza.command.memory import register_memory_commands
