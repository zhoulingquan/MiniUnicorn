...
MCP_PRESETS: tuple[McpPreset, ...] = (
    ...
    # === 远程 MCP preset（streamableHttp）==================================
    # browserbase: 云端浏览器自动化，API Key 通过 URL query 参数注入。
    McpPreset(
        name="browserbase",
        ...
        note="在 browserbase.com 创建 API Key 后启用。",
    ),
    # firecrawl: 网页抓取与搜索，API Key 通过环境变量注入。
    McpPreset(
        name="firecrawl",
        display_name="Firecrawl",
        category="search",
        description="Web crawling and search",
        ...
        requires="Node.js + Firecrawl API key",
        note="在 firecrawl.dev 创建 API Key 后启用。",
    ),
    # figma: 设计稿读取，API Key 通过环境变量注入。
    McpPreset(
        name="figma",
        display_name="Figma",
        category="design",
        ...
        requires="Node.js + Figma API key",
        note="在 figma.com → Settings → Personal access tokens 生成 Token。",
    ),
    # exa: AI 搜索，无需鉴权的远程 MCP。
    McpPreset(
        name="exa",
        display_name="Exa",
        category="search",
    ...
    # microsoft-learn: 微软官方文档，无需鉴权的远程 MCP。
    McpPreset(
        name="microsoft-learn",
        display_name="Microsoft Learn",
        category="docs",
        description="Microsoft Learn documentation MCP",
    ...
    # aws-docs: AWS 官方文档，无需鉴权的远程 MCP。
    McpPreset(
        name="aws-docs",
        display_name="AWS Docs",
        category="docs",
        description="AWS documentation MCP",
        ...
        server=MCPServerConfig(
            type="streamableHttp",
            url="https://docs.aws.amazon.com/mcp",
        ),
        requires="",
        note="无需 API Key，开箱即用。",
    ),
    # postman: API 集合管理，API Key 通过环境变量注入。
    McpPreset(
        name="postman",
        display_name="Postman",
        category="dev",
        description="Postman API collection management",
        docs_url="https://www.postman.com",
        transport="stdio",
        install_supported=True,
        ...
        requires="Node.js + Postman API key",
        note="在 postman.com → Settings → API keys 生成 Key。",
    ),
)
