"""JSON Schema fragment types: all subclass :class:`~miniunicorn.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~miniunicorn.tools.base.Schema.validate_json_schema_value` /
  :class:`~miniunicorn.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~miniunicorn.tools.base.Schema`.
...
from miniunicorn.tools.base import Schema
