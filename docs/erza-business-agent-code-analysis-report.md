# Erza 面向小型企业长期使用的业务智能体源码分析报告

> 报告日期：2026-08-26  
> 分析基线：当前工作区源码  
> 分析原则：以 `erza/` 源码中的类、函数、调用关系、配置默认值和持久化实现为主要依据；不以 README 作为架构事实来源。  
> 目标场景：单用户、小型企业、长期运行的业务智能体，暂不考虑多用户平台化。

## 1. 执行摘要

Erza 当前已经具备较完整的通用 Agent Harness 能力：消息接收、模型调用、工具执行、会话持久化、记忆、上下文治理、Provider 切换、失败恢复、子 Agent、定时任务、WebUI、API 和多渠道接入均已有代码实现。
...
- `erza/agent/turn_orchestrator.py`
- `erza/agent/dispatch.py`
- `erza/agent/turn_telemetry.py`
...
- `erza/agent/execution/tool_execution.py`
...
- `erza/agent/memory_models.py`
- `erza/agent/memory_repository.py`
- `erza/agent/memory_lifecycle.py`
- `erza/agent/memory_recall.py`
- `erza/agent/memory_extraction.py`
- `erza/agent/dream_trigger.py`
...
- `erza/agent/context_strategies/schema_crop.py`
- `erza/agent/autocompact.py`
...
- `erza/agent/skills.py`
- `erza/templates/agent/`
...
- `erza/providers/base.py`
- `erza/providers/openai_compat_provider.py`
- `erza/providers/openai_responses/parsing.py`
- `erza/agent/execution/model_request.py`
...
- `erza/session/writes.py`
- `erza/agent/session_turn.py`
- `erza/session/goal_state.py`
- `erza/utils/gitstore.py`
...
- `erza/providers/base.py`
- `erza/providers/fallback_provider.py`
- `erza/agent/execution/recovery.py`
- `erza/agent/reflection.py`
...
- `erza/agent/safety_policy.py`
- `erza/agent/execution/tool_execution.py`
- `erza/security/workspace_access.py`
- `erza/security/network.py`
- `erza/agent/tools/sandbox.py`
- `erza/pairing/store.py`
...
- `erza/agent/step_acceptance.py`
- `erza/agent/progress_policy.py`
...
- `erza/agent/subagent_registry.py`
...
- `erza/agent/turn_budget.py`
- `erza/agent/call_ledger.py`
- `erza/agent/execution/recovery.py`
- `erza/agent/execution/model_request.py`
...
从当前源码看，Erza 的通用 Agent 底盘已经基本形成，较强的部分包括：
